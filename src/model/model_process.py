    ...
    def process_epoch(self, model):
        ...
        for batch in self.data_loader:
            ...
            if self.args.predict_result and stage == "Test":
                ...
                predict_result_path = f"./save/predict_result/lora_kge/"  + self.args.dataset + " " + str(self.args.ent_r) + " " + str(self.args.num_ent_layers) + " " + str(self.args.learning_rate) + " " + str(self.args.batch_size) +"/"
                if not os.path.exists(predict_result_path):
                    os.makedirs(predict_result_path)
                predict_result_path = predict_result_path + str(self.args.snapshot) + "_" + str(self.args.snapshot_test) + ".txt"
